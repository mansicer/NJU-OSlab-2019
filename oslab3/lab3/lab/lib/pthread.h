...
/**
 * when you create a Process in your OS, there is no thread, you need initial these Process as a thread, 
 * so when you create a thread, they are in same structure.
**/
